...
const features = [
  {
    ...
    description: 'Enroll in courses, submit complaints, and manage ID card requests with ease.',
    icon: <BookOpen className="h-6 w-6" />,
  },
  {
    name: 'Faculty Portal',
    description: 'View enrolled students, submit leave requests, and check attendance reports.',
    icon: <Users className="h-6 w-6" />,
  },
  {
    name: 'Administrative Tools',
    description: 'Approve ID cards, assign faculty to subjects, and resolve complaints efficiently.',
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">GLA University</span>
            </div>
          ...
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                >
                  <span className="block text-white">University Service</span>
                ...
                >
                  A centralized platform for students, faculty, and administrators to manage university services efficiently.
                </motion.p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                Our platform simplifies university administrative processes for all stakeholders.
              </p>
            </div>
        ...
        <div className="bg-blue-700">
          <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg leading-6 text-blue-100">
              Join our platform today and experience the benefits of a streamlined university service management system.
            </p>
            <Link
              to="/register"
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2025 GLA University. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
